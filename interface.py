...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        sizePolicy3.setHeightForWidth(self.GraficoWidget.sizePolicy().hasHeightForWidth())
        self.GraficoWidget.setSizePolicy(sizePolicy3)
        self.GraficoWidget.setMinimumSize(QSize(0, 0))
